...
public class Quickstart {
	...
	private static final Configuration wmConfig = WMConfig.getConfig();
	...
	private static final java.io.File DATA_STORE_DIR = new java.io.File("/opt/conf");
	...
	public static Credential authorize() throws IOException {
		...
		LOGGER.info("apiKeyLocation: " + apiKeyLocation);

		InputStream in = new FileInputStream(apiKeyLocation);
	...
	public static void main(String[] args) throws IOException {
		...
		parameters.put("channelId", "UCaWd5_7JhbQBe4dknZhsHJg");
	...
	private void getChannelDetails() throws IOException {
		YouTube youtube = getYouTubeService();
		try {
			YouTube.Channels.List channelsListByUsernameRequest = youtube.channels()
					.list("snippet,contentDetails,statistics");
			channelsListByUsernameRequest.setForUsername("WatchMojo");
